	...
	public static void main(String[] args) throws IOException {
		...
		try {
			...
			for (int i = 0; i < fileLines; i++) {
				int k = 0;
				String[] tempString = DMDDfind(lineArray[i].trim());
	...
	public static String[] DMDDfind(String processorName) throws IOException {
		...
		try {
			...
			if (found == false) {
				...
				failed[0] = (realProcessorName + ", Sorry. Could not find the processor you were looking for. It may be depracated or does not exist.");
				failed[1] = "end";
				return failed;
			}
