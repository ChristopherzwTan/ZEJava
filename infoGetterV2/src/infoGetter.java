...
public class infoGetter {
	...
	public static void main(String[] args) throws IOException {
		...
		String fileName = "U:" + "\\" + "arrangeMe2.txt";
		String writeFile = "U:" + "\\" + "SheetofCredentials.txt";
		...
		try
		{
			...
			{	
				...
				if (lineArray[i].startsWith("	 com.ze.datamanager.processor."))
				{
					//processor = printProcessor(lineArray[i]);
					processor = lineArray[i];
					processor = printProcessor(processor);
				...
				else if (lineArray[i].startsWith(" A") || lineArray[i].startsWith(" B")
				...
				{
					if (!processor.equals("EMPTY") && !password.equals("EMPTY") && !userName.equals("EMPTY"))
					{
